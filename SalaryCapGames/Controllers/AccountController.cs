...
using SalaryCapGames.Views.WebViewModels.AccountViewModels;
        ...
        public async Task<IActionResult> Register( RegisterViewModel model, string returnUrl = null )
        {
            ...
            if ( ModelState.IsValid )
            {
                ...
                if ( result.Succeeded )
                {
                    ...
                    if ( !await _roleManager.RoleExistsAsync( Common.AdminUser ) )
                        await _roleManager.CreateAsync( new IdentityRole( Common.AdminUser ) );

                    if ( !await _roleManager.RoleExistsAsync( Common.OwnerUser ) )
