...
namespace SalaryCapData.Migrations
{
    ...
    [Migration("20180531205331_Fixed bug in edit profile")]
    partial class Fixedbugineditprofile
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalaryCapData.Data.Models.FranchisePlayers", b =>
                {
                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "Catcher")
                        .WithMany()
                        .HasForeignKey("CatcherId");

                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "DesignatedHitter")
                        .WithMany()
                        .HasForeignKey("DesignatedHitterId");

                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "FirstBase")
                        .WithMany()
                        .HasForeignKey("FirstBaseId");

                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "Outfield1")
                        .WithMany()
                        .HasForeignKey("Outfield1Id");

                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "Outfield2")
                        .WithMany()
                        .HasForeignKey("Outfield2Id");

                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "Outfield3")
                        .WithMany()
                        .HasForeignKey("Outfield3Id");

                    b.HasOne("SalaryCapData.Data.Models.PitcherStats", "Pitcher1")
                        .WithMany()
                        .HasForeignKey("Pitcher1Id");

                    b.HasOne("SalaryCapData.Data.Models.PitcherStats", "Pitcher2")
                        .WithMany()
                        .HasForeignKey("Pitcher2Id");

                    b.HasOne("SalaryCapData.Data.Models.PitcherStats", "Pitcher3")
                        .WithMany()
                        .HasForeignKey("Pitcher3Id");

                    b.HasOne("SalaryCapData.Data.Models.PitcherStats", "Pitcher4")
                        .WithMany()
                        .HasForeignKey("Pitcher4Id");

                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "SecondBase")
                        .WithMany()
                        .HasForeignKey("SecondBaseId");

                    b.HasOne("SalaryCapData.Data.Models.HitterStats", "ShortStop")
                        .WithMany()
